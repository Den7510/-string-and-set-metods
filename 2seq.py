...
list_numbrs = input('Ввдите набор цифр через запятую: ')
print(list_numbrs.split(','))
numbrs_original = set(list_numbrs.split(','))
print(numbrs_original)
once = []
for i in list_numbrs:
    if list_numbrs.count(i) == 1:
        once.append(i)
        print(once)
