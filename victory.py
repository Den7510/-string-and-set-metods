...
# Программа выбирает из этих 10-и 5 случайных людей, это можно реализовать с помощью модуля random и
# функции sample
...
# 1 H Kolumb = 31.10.1451 (октябрь)
# 2 A Enchtein = 14.03.1879 (март)
# 3 A Puchkin = 06.06.1799 (июнь)
# 4 L Paster = 27.12.1822 (декабрь)
# 5 G Galilei = 15.02.1564 (февраль)
# 6 W Shekspir = 26.04.1564 (апрель)
# 7 L De Vinchi = 15.04.1452 (апрель)
# 8 A Mozart = 27.01.1756 (январь)
# 9 I Newton = 04.01.1643 (январь)
# 10 G Leibniz = 01.07.1646 (июль)
str = 'да'
while str == 'да':
